...
$config['csrf_exclude_uris'] = array(
    'admin/product/process_bulk_upload', 'auth/login', 'compare/add_to_compare','admin/home/reset-password', 'login/logout', 'cart/manage', 'admin/setting/update_seller_flow', 'auth/[a-z_-]+', 'admin/return_request/update-return-request', 'delivery_boy/orders/update_return_order_item_status', 'cart/place-order','my-account/[a-z_-]+','my-account/update-order-item-status', 'admin/custom_sms/view_sms_by_id', 'admin/Sms_gateway_settings/update_notification_module', 'admin/product/get_subcategory', 'admin/themes/switch',
    'admin/setting/set-default-theme','my-account/manage-favorites', 'admin/updater/upload_update_file', 'my-account/get-zipcode', 'admin/webhook/spr_webhook', 'cart/pre-payment-setup',
    'cart/validate-promo-code', 'my-account/get-address', 'payment/[a-z_-]+', 'admin/category/add_category',
    ...
    'app/v1/Chat_Api/[a-z_-]+', 'seller/app/v1/Chat_Api/[a-z_-]+','delivery_boy/login/create_delivery_boy', 'admin/webhook/[a-z_-]+', 'admin/media/upload', 'admin/webhook/phonepe_webhook', 'admin/chat/[a-z_-]+', 'seller/chat/[a-z_-]+', 'admin/orders/[a-z_-]+', 'seller/orders/[a-z_-]+'
);
