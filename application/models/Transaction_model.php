...
class Transaction_model extends CI_Model
{
    ...
    function get_transactions_list($user_id = '', $group_id = 2, $transaction_type = '')
    {
        ...
        $txn_count = $count_res->join('users', ' transactions.user_id = users.id', 'left')->join('users_groups ug', 'ug.user_id = users.id')->get('transactions')->result_array();
