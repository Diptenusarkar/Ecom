        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent nav-flat mb-5" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                ...
                <?php if (has_permissions('read', 'product') || has_permissions('read', 'attribute') || has_permissions('read', 'attribute_set') || has_permissions('read', 'attribute_value') || has_permissions('read', 'tax') || has_permissions('read', 'product_order')) { ?>
                    <li class="nav-item has-treeview ">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <?php } ?>
                            <li class="nav-item">
                                <a href="<?= base_url('admin/product/product_bulk_edit') ?>" class="nav-link">
                                    <i class="fas fa-sitemap nav-icon"></i>
                                    <p>Product Bulk Update</p>
                                </a>
                            </li>
                ...
                <?php if (has_permissions('read', 'affiliate_system')) { ?>
                    <li class="nav-item has-treeview ">
                        <a href="#" class="nav-link">
                            <i class="fas fa-handshake nav-icon text-yellow"></i>
                            <p>
                                Affiliate System
                                <i class="right fas fa-angle-left"></i>
                            </p>
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="<?= base_url('admin/affiliate/') ?>" class="nav-link">
                                    <i class="fas fa-tachometer-alt nav-icon"></i>
                                    <p>Dashboard</p>
                                </a>
                            </li>
                            <?php if (has_permissions('read', 'affiliate_users')) { ?>
                                <li class="nav-item">
                                    <a href="<?= base_url('admin/affiliate_users') ?>" class="nav-link">
                                        <i class="fas fa-users nav-icon"></i>
                                        <p>Affiliate Users</p>
                                    </a>
                                </li>
                            ...
                            <?php if (has_permissions('read', 'affiliate_settings')) { ?>
                                <li class="nav-item">
                                    <a href="<?= base_url('admin/affiliate_settings') ?>" class="nav-link">
                            ...
                            <?php } ?>
                            <li class="nav-item">
                                <a href="<?= base_url('admin/affiliate_policies') ?>" class="nav-link">
