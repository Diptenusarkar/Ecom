                                ...
                                <div class="d-flex">
                                    <div class="firebase_config d-none">
                                        <a href="<?= base_url('admin/web-setting/firebase') ?>">
                                            <p class="text-info">Please config firebase config here<i class="fa fa-arrow-right mx-2 text-xs"></i></p>
                                        </a>
                                    </div>
                                    <div class="sms_gateway d-none">
                                        <a href="<?= base_url('admin/sms-gateway-settings') ?>">
                                            <p class="text-info">Please config SMS gateway config here<i class="fa fa-arrow-right mx-2 text-xs"></i></p>
                                        </a>
                                    </div>
                                </div>
