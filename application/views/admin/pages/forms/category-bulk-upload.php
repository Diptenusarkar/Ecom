                        ...
                        <form class="form-horizontal" action="<?= base_url('admin/category/process_bulk_upload'); ?>" method="POST" id="bulk_upload_form">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="file" name="upload_file" class="form-control file_upload_height" accept=".csv" />
                                    </div>
                                ...
                                <?php  
                                $date = date('Ymd'); 
                                $filename_category = "category_".$date.".csv";
                                ?>
                                <div class="form-group row">
                                    <div class="card-body pad">
                                        <div class="form-group">
                                            <a href="<?= base_url('uploads/category-bulk-upload-sample.csv') ?>" class="btn btn-info mb-3 " download="category-bulk-upload-sample.csv">Bulk upload sample file <i class="fas fa-download"></i></a>

                                            <a href="<?= base_url('uploads/category-bulk-update-sample.csv') ?>" class="btn btn-info mb-3" download="category-bulk-update-sample.csv">Bulk update sample file <i class="fas fa-download"></i></a>
                                            <a href="<?= base_url('admin/category/category_bulk_dowload') ?>" class="btn btn-info mb-3" download="<?= $filename_category ?>">Category Bulk Download file <i class="fas fa-download"></i></a>
