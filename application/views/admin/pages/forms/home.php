<div class="content-wrapper">
    <section class="content">
        <div class="container-fluid p-3">
            ...
            <?php if (has_permissions('read', 'seller')) { ?>
                <div class="row mt-3">
                        ...
                        <div class="col-4">
                            <div class="small-box bg-danger">
                                <div class="inner">
                                    ...
                                    <p><button class='btn btn-outline-danger text-white border-0' data-toggle="modal" data-target="#deactive_sellers">Deactivated sellers</button></p>
                                </div>
                                <div class="icon">
                    ...
                    <div class="container-fluid mt-3">
                        <div class="row">
                            <div class="col-md-<?php echo has_permissions('read', 'categories') ? '6' : '12'; ?> col-12">
                                <div class="card h-100">
                                    <div class="m-3">Top Sellers</div>
                                    <div class="card-body">
                                        <table class="table-striped" id="top_sellers_table"
                                            data-toggle="table"
                            ...
                            <?php if (has_permissions('read', 'categories')) { ?>
                                <div class="col-md-6 col-12">
                                    <div class="card h-100">
                                        ...
                                        <div class="card-body">
                                            <table class="table-striped" id="top_categories_table"
                                                data-toggle="table"
            ...
            <!-- Order Items Outlines Row -->
            <?php if (has_permissions('read', 'orders')) { ?>
                <div class="row mt-3">
                    <h5 class="col">Order Items Outlines</h5>
                    <div class="row col-12 d-flex">
                        <div class="col-3">
                            ...
                            "ignoreColumn": ["state"]
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="items" data-sortable='true' data-visible="false" data-formatter="itemsReadMoreFormatter">Items</th>
                                        <th data-field="total" data-sortable='true' data-visible="true">Total(<?= $currency ?>)</th>
                                        ...
                                        <th data-field="wallet_balance" data-sortable='true' data-visible="true">Wallet Used(<?= $currency ?>)</th>
                                        <th data-field="promo_code" data-sortable='true' data-visible="false">Promo Code</th>
                                        <th data-field="promo_discount" data-sortable='true' data-visible="true">Promo disc.(<?= $currency ?>)</th>
                                        <th data-field="final_total" data-sortable='true'>Final Total(<?= $currency ?>)</th>
                                        ...
                                        <th data-field="address" data-sortable='true' data-visible="true">Address</th>
