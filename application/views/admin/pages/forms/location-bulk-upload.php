                    ...
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal" action="<?= base_url('admin/area/process_bulk_upload'); ?>" method="POST" id="location_bulk_upload_form">
                            <div class="card-body">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="type" class="col-form-label">Location Type <small>[Zipcodes/Cities]</small> <span class='text-danger text-sm'>*</span></label></label>
                                ...
                                <div class="form-group row">
                                    <div class="card-body pad">
                                        <div class="form-group zipcode_samples">
                                            ...
                                            <a href="<?= base_url('admin/area/zipcode_bulk_dowload') ?>" class="btn btn-info mt-1 mb-1 col-md-3" download="<?= $filename_zipcode ?>">Zipcode Bulk Download file <i class="fas fa-download"></i></a>
                                        </div>
                                        <div class="form-group city_samples">
                                            ...
                                            <a href="<?= base_url('admin/area/cities_bulk_dowload') ?>" class="btn btn-info mt-1 mb-1 col-md-3" download="<?= $filename_city ?>">City Bulk Download file <i class="fas fa-download"></i></a>
                                        </div>
                                        <div class="form-group">
