                        ...
                        <form class="form-horizontal form-submit-event" action="<?= base_url('admin/Payment_settings/update_payment_settings'); ?>" method="POST" id="payment_setting_form">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-8">
                                        <input type="text" class="form-control" name="paypal_client_id" value="<?= @$settings['paypal_client_id'] ?>" placeholder="Paypal Client id" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-4">
                                    ...
                                    <div class="form-group col-md-8">
                                        <input type="text" class="form-control" name="paypal_secret_key" value="<?= @$settings['paypal_secret_key'] ?>" placeholder="Paypal Secret Key" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-8">
                                        <input type="text" class="form-control" name="stripe_webhook_url" value="<?= base_url("app/v1/api/stripe_webhook"); ?>" disabled />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-8">
                                        <select name="midtrans_payment_mode" class="form-control">
                                            ...
                                            <option value="production" <?= (isset($settings['midtrans_payment_mode']) && $settings['midtrans_payment_mode'] == 'production') ? 'selected' : '' ?>>Live</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-8">
                                        <input type="checkbox" name="instamojo_payment_method" <?= (@$settings['instamojo_payment_method']) == '1' ? 'Checked' : '' ?> data-bootstrap-switch data-off-color="danger" data-on-color="success">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-4">
                                    ...
                                    <div class="form-group col-md-8">
                                        <select name="instamojo_payment_mode" class="form-control">
                                            <option value="">Select Mode</option>
                                            <option value="sandbox" <?= (isset($settings['instamojo_payment_mode']) && $settings['instamojo_payment_mode'] == 'sandbox') ? 'selected' : '' ?>>Sandbox</option>
                                            <option value="live" <?= (isset($settings['instamojo_payment_mode']) && $settings['instamojo_payment_mode'] == 'live') ? 'selected' : '' ?>>Live</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-8">
                                            <input type="text" class="form-control" name="phonepe_client_id" value="<?= @$settings['phonepe_client_id']  ?>" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                        ...
                                        <div class="form-group col-md-8">
                                            <input type="text" class="form-control" name="phonepe_client_secret" value="<?= @$settings['phonepe_client_secret']  ?>" />
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <input type="number" class="form-control" step="any" name="min_cod_amount" value="<?= @$settings['min_cod_amount'] ?>" placeholder="Minimum COD Amount" />
                                    </div>
                                    <div class="form-group col-md-6">
                                        <input type="number" class="form-control" step="any" name="max_cod_amount" value="<?= @$settings['max_cod_amount'] ?>" placeholder="Maximum COD Amount" />
                                    </div>
                                </div>
