                ...
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal" action="<?= base_url('admin/product/add_product'); ?>"
                            ...
                            <?php } ?>
                            <input type="hidden" id="affiliate_categories"
                                value="<?= (isset($affiliate_categories)) ? $affiliate_categories : "" ?>">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row col-md-12">
                                    <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                        ...
                                        <select id="seller-select" name="seller_id" class="form-control">
                                            ...
                                            ?>
                                                <option value="<?= $seller[0]['seller_id'] ?>"
                                                    <?= (isset($product_details[0]['seller_id']) && $product_details[0]['seller_id'] == $seller[0]['seller_id']) ? 'selected' : "" ?>>
                                                    <?= $seller[0]['seller_name'] . ' ' . '-' . ' ' . $seller[0]['store_name'] . ' ' . '(store)' ?>
                                                </option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                ...
                                <div class="form-group col-md-12">
                                    <label for="short_description" class="col-form-label">Short Description <span
                                            class='text-danger text-sm'>*</span></label>
                                    <textarea type="text" class="form-control addr_editor" id="short_description"
                                ...
                                <div class="form-group row">
                                    <div class="col-md-8">
                                        <div class="row col mt-3">
                                            <div class="col-md-4">
                                                ...
                                                <select name="pro_input_tax[]"
                                                    class="tax_list form-control select_multiple w-100" multiple>
                                                    <option value="">
                                                        <?php
                                            ...
                                            <div
                                                class="col-md-4 indicator <?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                                <label for="indicator" class="col-form-label">Indicator</label>
                                                <select class='form-control' name='indicator'>
                                                    <option value='0' <?= (isset($product_details[0]['indicator']) && $product_details[0]['indicator'] == '0') ? 'selected' : ''; ?>>
                                                        None</option>
                                                ...
                                                <select class="col-md-12 form-control country_list" id="country_list"
                                                    ...
                                                    ?>
                                                        <option value="<?= $product_details[0]['made_in'] ?>"
                                                            <?= (isset($product_details[0]['made_in']) && $product_details[0]['made_in'] == $countries[0]['name']) ? 'selected' : ''; ?>><?= $product_details[0]['made_in'] ?>
                                                        </option>
                                                    <?php } ?>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <select class=" col-md-12  form-control admin_brand_list"
                                                    id="admin_brand_list" name="brand">
                                                    <?php

                                                    if (isset($product_details[0]['brand']) && $product_details[0]['brand'] != '' && isset($brands) && !empty($brands)) {
                                                    ?>
                                                        <option value="<?= $product_details[0]['brand'] ?>"
                                                            <?= (isset($product_details[0]['brand']) && $product_details[0]['brand'] === $brands[0]['id']) ? 'selected' : ''; ?>><?= $brands[0]['name'] ?></option>
                                                    <?php } ?>
                                                    <!-- brands display here  -->
                                                </select>
                                            </div>
                                            <div
                                                class="col-md-4 total_allowed_quantity <?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                                <label for="total_allowed_quantity" class="col-form-label">Total Allowed
                                                    Quantity</label>
                                                <input type="number" class="col-md-12 form-control"
                                                    id="total_allowed_quantity" name="total_allowed_quantity" min="1"
                                            ...
                                            <div
                                                class="col-md-4 minimum_order_quantity <?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                                <label for="minimum_order_quantity" class="col-form-label">Minimum Order
                                                    Quantity</label>
                                                <input type="number" class="col-md-12 form-control"
                                                    id="minimum_order_quantity" name="minimum_order_quantity" min="1"
                                                    value="<?= (isset($product_details[0]['minimum_order_quantity'])) ? $product_details[0]['minimum_order_quantity'] : 1; ?>"
                                                    placeholder='Minimum Order Quantity'>
                                            </div>
                                            <div
                                                class="col-md-4 quantity_step_size <?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                                <label for="quantity_step_size" class="col-form-label">Quantity Step
                                                    Size</label>
                                                <input type="number" class="col-md-12 form-control"
                                                    id="quantity_step_size" name="quantity_step_size" min="1"
                                                    value="<?= (isset($product_details[0]['quantity_step_size'])) ? $product_details[0]['quantity_step_size'] : 1; ?>"
                                                    placeholder='Quantity Step Size'>
                                            </div>
                                            <div
                                                class="col-md-4 warranty_period <?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                                <label for="warranty_period" class="col-form-label">Warranty
                                                    Period</label>
                                                <input type="text" class="col-md-12 form-control" id="warranty_period"
                                                    name="warranty_period"
                                                    value="<?= (isset($product_details[0]['warranty_period'])) ? $product_details[0]['warranty_period'] : "" ?>"
                                                    placeholder='Warranty Period if any'>
                                            </div>
                                            <div
                                                class="col-md-4 guarantee_period <?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                                <label for="guarantee_period" class="col-form-label">Guarantee
                                                    Period</label>
                                                <input type="text" class="col-md-12 form-control" id="guarantee_period"
                                            ...
                                            <div class="form-group col-md-6 mt-3 deliverable_type">
                                                <div
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group col-md-6">
                                                                <label for="deliverable_type"
                                                                    class="col-form-label">Deliverable Type</label>
                                                                <select class="form-control" name="deliverable_type"
                                                                    id="deliverable_type">
                                                                    <option value="<?= NONE ?>"
                                                                        <?= (isset($product_details[0]['deliverable_type']) && $product_details[0]['deliverable_type'] == NONE) ? 'selected' : ''; ?>>None</option>
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                <label for="deliverable_zipcodes"
                                                                    class="col-form-label">Deliverable Zipcodes</label>
                                                                <?php
                                                                ...
                                                                <select name="deliverable_zipcodes[]"
                                                                    class="search_zipcode form-control w-100" multiple
                                                                    onload="multiselect()" id="deliverable_zipcodes"
                                                                    ...
                                                                    ?>
                                                                            <option value="<?= $row['id'] ?>"
                                                                                <?= (in_array($row['id'], $zipcodes)) ? 'selected' : ''; ?>><?= $row['zipcode'] ?></option>
                                                                    <?php }
                                                                    } ?>
                                                                </select>
                                                            </div>
                                                    ...
                                                    if (isset($shipping_method['city_wise_deliverability']) && $shipping_method['city_wise_deliverability'] == 1 && $shipping_method['shiprocket_shipping_method'] != 1) { ?>
                                                        <div class="row">
                                                            <div class="form-group col-md-6">
                                                                <label for="" class="col-form-label">Deliverable City
                                                                    Type</label>
                                                                <select class="form-control" name="deliverable_city_type"
                                                                    ...
                                                                    <?php } ?>
                                                                    <!-- <option value="<? //= INCLUDED 
                                                                                        ?>" <? //= (isset($product_details[0]['deliverable_city_type']) && $product_details[0]['deliverable_city_type'] == INCLUDED) ? 'selected' : ''; 
                                                                                            ?>>Included</option> -->
                                                                    <option value="<?= EXCLUDED ?>"
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                <label for="cities" class="col-form-label">Deliverable
                                                                    Cities</label>
                                                                <div class="">
                                                                    <?php
                                                                    ...
                                                                    <select class="form-control city_list"
                                                                        name="deliverable_cities[]" id="deliverable_cities"
                                                                        multiple
                                                                        <?= (isset($product_details[0]['deliverable_city_type']) && ($product_details[0]['deliverable_city_type'] == INCLUDED || $product_details[0]['deliverable_city_type'] == EXCLUDED)) ? "" : "disabled" ?>>
                                                                        <?php foreach ($cities as $row) { ?>
                                                                            <option value="<?= $row['id'] ?>"
                                                                                <?= (in_array($row['id'], $selected_city_ids)) ? 'selected' : ''; ?>><?= $row['name'] ?></option>
                                                                        <?php }; ?>
                                                                    </select>
                                                                </div>
                                                            </div>
                                            ...
                                            <!-- HSN Code -->
                                            <div
                                                class="col-md-4 col-sm-12 mt-3 hsn_code <?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                                <label for="hsn_code" class="col-form-label">HSN Code</label>
                                                <input type="text" class="col-md-12 form-control" name="hsn_code"
                                                    id="hsn_code"
                                                    value="<?= (isset($product_details[0]['hsn_code'])) ? $product_details[0]['hsn_code'] : "" ?>"
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md-6">
                                                <label for="low_stock_limit" class="col-form-label">Low Stock
                                                    Limit<small>(Seller’s default low stock limit will apply if this is not specified)</small></label>
                                            ...
                                            <div class="col-md-6 pickup_locations <?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                                <div class="standdard_shipping">
                                                    <label for="shipping_type" class="col-form-label">Select Pickup Location For standdard
                                                        shipping
                                                        <?php
                                                        if (isset($shipping_method['shiprocket_shipping_method']) && $shipping_method['shiprocket_shipping_method'] == 1) {
                                                            echo "<span class='text-danger text-sm'>*</span>";
                                                        }
                                                        ?>
                                                    </label>
                                                    ...
                                                    <select class='form-control shiprocket_type' name="pickup_location"
                                                        ...
                                                        <?php foreach ($shipping_data as $row) {
                                                            ...
                                                            <option <?php if ($row['pickup_location'] == $pickup_location) { ?> selected <?php } ?>
                                        ...
                                        <div class="row col mt-3">
                                            ...
                                            <?php if (isset($payment_method['cod_method']) && $payment_method['cod_method'] == 1) { ?>
                                                <div
                                                    class="col-md-3 col-xs-6 cod_allowed <?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                                    <label for="cod_allowed" class="col-form-label">Is COD allowed?</label>
                                                    <input type="checkbox" name="cod_allowed" id="cod_allowed"
                                            ...
                                            ?>
                                            <div
                                                class="col-md-3 col-xs-6 is_returnable <?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                            ...
                                            <div
                                                class="col-md-3 col-xs-6 is_cancelable <?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                                <label for="is_cancelable" class="col-form-label">Is cancelable ?
                                                </label>
                                                <input type="checkbox" name="is_cancelable" id="is_cancelable"
                                                    class="switch" <?= (isset($product_details[0]['is_cancelable']) && $product_details[0]['is_cancelable'] == '1') ? 'Checked' : ''; ?>
                                                    data-bootstrap-switch data-off-color="danger"
                                                    data-on-color="success">
                                            </div>
                                            <div class="col-md-3 col-xs-6 <?= (isset($product_details[0]['is_cancelable']) && $product_details[0]['is_cancelable'] == 1) ? '' : 'collapse' ?>"
                                                ...
                                                <label for="cancelable_till" class="col-form-label">Till which status ?
                                                    <span class='text-danger text-sm'>*</span></label>
                                                <input type="text" class="form-control" name="cancelable_till"
                                                    placeholder="cancelable_till" id="cancelable_till" value="received"
                                                    disabled>
                                                <input type="hidden" class="form-control" name="cancelable_till"
                                                    placeholder="cancelable_till" id="cancelable_till" value="received">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row col mt-3 is_attachment_required <?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                            <div class="col-md-4">
                                                <label for="is_prices_inclusive_tax" class="col-form-label">Tax included
                                                    in prices?</label>
                                                <input type="checkbox" name="is_prices_inclusive_tax"
                                                    id="is_prices_inclusive_tax"
                                                    <?= (isset($product_details[0]['is_prices_inclusive_tax']) && $product_details[0]['is_prices_inclusive_tax'] == '1') ? 'checked' : '' ?> data-bootstrap-switch data-off-color="danger"
                                                    data-on-color="success" data-on-text="Yes" data-off-text="No">
                                            </div>
                                            <div
                                                class="col-md-4  is_attachment_required <?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                                <label for="is_attachment_required"
                                                    class="col-form-label is_attachment_required">Is Attachment Required
                                                    ?</label>
                                                <a class=" form-switch  mr-1 mb-1" title="Deactivate"
                                                    href="javascript:void(0)">
                                                    <input type="checkbox" class="form-check-input " role="switch"
                                                        id="is_attachment_required" name="is_attachment_required"
                                                        <?= (isset($product_details[0]['is_attachment_required']) && $product_details[0]['is_attachment_required'] == '1') ? 'Checked' : '' ?> data-bootstrap-switch data-off-color="danger"
                                                        data-on-color="success" />
                                                </a>
                                            </div>
                                            <div
                                                class="col-md-4  is_in_affiliate <?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                                <label for="is_in_affiliate"
                                                    class="col-form-label is_in_affiliate">Is In Affiliate
                                                    ?</label>
                                                <a class=" form-switch  mr-1 mb-1" title="Deactivate"
                                                    href="javascript:void(0)">
                                                    <input type="checkbox" class="form-check-input " role="switch"
                                                        name="is_in_affiliate" id="is_in_affiliate"
                                                        <?= (isset($product_details[0]['is_in_affiliate']) && $product_details[0]['is_in_affiliate'] == '1') ? 'Checked' : '' ?> data-bootstrap-switch data-off-color="danger"
                                                        data-on-color="success" />
                                                </a>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col pt-4 pb-4">
                                                <div class="form-group col-sm-12">
                                                    <label for="image">Main Image <span
                                                            class='text-danger text-sm'>*</span><small>(Recommended Size
                                                            : 180 x 180 pixels)</small></label>
                                                ...
                                                <div class="form-group">
                                                    <label for="other_images">Other Images <small>(Recommended Size :
                                                            180 x 180 pixels)</small></label>
                                                    <div class="col-sm-12">
                                                ...
                                                <div class="form-group d-flex">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select class='form-control' name='video_type' id='video_type'>
                                                            <option value=''
                                                                <?= (isset($product_details[0]['video_type']) && ($product_details[0]['video_type'] == '' || $product_details[0]['video_type'] == NULL)) ? 'selected' : ''; ?>>None</option>
                                                            <option value='self_hosted'
                                                                <?= (isset($product_details[0]['video_type']) && $product_details[0]['video_type'] == 'self_hosted') ? 'selected' : ''; ?>>Self Hosted</option>
                                                            <option value='youtube'
                                                                <?= (isset($product_details[0]['video_type']) && $product_details[0]['video_type'] == 'youtube') ? 'selected' : ''; ?>>Youtube</option>
                                                            <option value='vimeo'
                                                                <?= (isset($product_details[0]['video_type']) && $product_details[0]['video_type'] == 'vimeo') ? 'selected' : ''; ?>>Vimeo</option>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 mt-2 <?= (isset($product_details[0]['video_type']) && ($product_details[0]['video_type'] == 'self_hosted')) ? '' : 'd-none'; ?>"
                                                        ...
                                                        <label for="image" class="ml-2">Video <span
                                                                class='text-danger text-sm'>*</span></label>
                                                        <div class='col-md-3'><a
                                                                class="uploadFile img btn btn-primary text-white btn-sm"
                                        ...
                                        ?>
                                            <div class="col-md-12 row additional-info existing-additional-settings">
                                                <div class="row mt-4 col-md-12 ">
                                                    <nav class="w-100">
                                                        <div class="nav nav-tabs" id="product-tab" role="tablist">
                                                            ...
                                                            <a class="nav-item nav-link" id="tab-for-general-seo-section"
                                                                data-toggle="tab" href="#seo-section-settings" role="tab"
                                                                aria-controls="general-seo-section" aria-selected="true">SEO
                                                                Configuration</a>
                                                            ...
                                                            <a class="nav-item nav-link <?= ($product_details[0]['type'] == 'simple_product' || $product_details[0]['type'] == "digital_product") ? 'disabled d-none' : 'edit-variants'; ?>"
                                                ...
                                                <div class="tab-content p-3 col-md-12" id="nav-tabContent">
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <select name="type" id="product-type" class="form-control"
                                                                    ...
                                                                    <option value="simple_product"
                                                                        <?= ($product_details[0]['type'] == "simple_product") ? 'selected' : '' ?>>Simple Product</option>
                                                                    <option value="variable_product"
                                                                        <?= ($product_details[0]['type'] == "variable_product") ? 'selected' : '' ?>>Variable Product</option>
                                                                    <option value="digital_product"
                                                                        <?= ($product_details[0]['type'] == "digital_product") ? 'selected' : '' ?>>Digital Product</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div id='product-general-settings'>
                                                            ...
                                                            ?>
                                                                <div id="general_price_section">
                                                                    <div class="form-group">
                                                                        <label for="type" class="col-md-2">Price<span
                                                                    ...
                                                                    <div class="form-group row mt-3 <?= $product_details[0]['type'] == "digital_product" ? 'd-none' : '' ?>"
                                                                        id="product-dimensions">
                                                                        <div class="col-md-6">
                                                                            <label for="weight"
                                                                                class="control-label col-md-12"><small>(These
                                                                                    are the product parcel's
                                                                                    dimentions.)</small></label>
                                                                        </div>
                                                                    </div>
                                                                    <div
                                                                        class="form-group row  dimensions  <?= $product_details[0]['type'] == "digital_product" ? 'd-none' : '' ?>">
                                                                        <div class="col-3">
                                                                            <label for="weight"
                                                                                class="control-label col-md-12">Weight
                                                                                <small>(kg)</small> <span
                                                                                    class='text-danger text-xs'>*</span></label>
                                                                        ...
                                                                        <div class="col-3">
                                                                            <label for="height"
                                                                                class="control-label col-md-12">Height
                                                                        ...
                                                                        <div class="col-3">
                                                                            <label for="breadth"
                                                                                class="control-label col-md-12">Breadth
                                                                                <small>(cms)</small><span
                                                                                    class='text-danger text-xs'>*</span> </label>
                                                                            <input type="number" class="form-control"
                                                                        ...
                                                                        <div class="col-3">
                                                                            <label for="length"
                                                                                class="control-label col-md-12">Length
                                                                                <small>(cms)</small><span
                                                                                    class='text-danger text-xs'>*</span> </label>
                                                                            <input type="number" class="form-control"
                                                                    ...
                                                                    <div
                                                                        class="form-group <?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                                                        <div class="col">
                                                                            <input type="checkbox"
                                                                                name="simple_stock_management_status"
                                                                                class="align-middle simple_stock_management_status"
                                                                                <?= (isset($product_details[0]['id']) && $product_details[0]['stock_type'] != NULL) ? 'checked' : '' ?>> <span
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="col col-xs-12">
                                                                        <label class="control-label">SKU <span class='text-danger text-xs'>*</span></label>
                                                                    ...
                                                                    <div class="col col-xs-12">
                                                                        <label class="control-label">Total Stock <span class='text-danger text-xs'>*</span></label>
                                                                    ...
                                                                    <div class="col col-xs-12">
                                                                        <label class="control-label">Stock Status <span class='text-danger text-xs'>*</span></label>
                                                                        <select type="text"
                                                                            class="col form-control stock-simple-mustfill-field"
                                                                        ...
                                                                        <div class="row form-group">
                                                                            <div class="col-md-2 col-xs-6 ml-2">
                                                                                <label for="is_cod_allowed"
                                                                                    class="col-form-label">Is Download
                                                                                    allowed?</label>
                                                                                <input type="checkbox" name="download_allowed"
                                                                                    id="download_allowed" class="switch"
                                                                                    <?= (isset($product_details[0]['download_allowed']) && $product_details[0]['download_allowed'] == '1') ? 'Checked' : ''; ?> data-bootstrap-switch
                                                                                    data-off-color="danger" data-on-color="success">
                                                                            </div>
                                                                            <div class="col-md-3 col-xs-6 <?= (isset($product_details[0]['download_type'])) ? '' : 'collapse' ?>"
                                                                                id='download_type'>
                                                                                <label for="download_allowed"
                                                                                    class="col-form-label">Download Link Type <span
                                                                                        class='text-danger text-sm'>*</span></label>
                                                                                <select class='form-control'
                                                                                    ...
                                                                                    <option value='self_hosted'
                                                                                        <?= (isset($product_details[0]['download_type']) && $product_details[0]['download_type'] == 'self_hosted') ? 'selected' : '' ?>>Self Hosted</option>
                                                                                    <option value='add_link'
                                                                                        <?= (isset($product_details[0]['download_type']) && $product_details[0]['download_type'] == 'add_link') ? 'selected' : '' ?>>Add Link</option>
                                                                                </select>
                                                                            </div>
                                                                            <div class="col-md-6 <?= (isset($product_details[0]['download_type']) && ($product_details[0]['download_type'] == 'add_link')) ? '' : 'd-none'; ?>"
                                                                                id="digital_link_container">
                                                                                <label for="video"
                                                                                    class="col-form-label ml-1">Digital Product Link
                                                                                    <span
                                                                                        class='text-danger text-sm'>*</span></label>
                                                                                <input type="url" class='form-control'
                                                                                    name='download_link' id='download_link'
                                                                                    value="<?= (isset($product_details[0]['download_type']) && ($product_details[0]['download_type'] == 'add_link')) ? $product_details[0]['download_link'] : ''; ?>"
                                                                                    placeholder="Paste digital product link or URL here">
                                                                            </div>
                                                                            <div class="col-md-6 mt-2 <?= (isset($product_details[0]['download_type']) && ($product_details[0]['download_type'] == 'self_hosted')) ? '' : 'd-none'; ?>"
                                                                                ...
                                                                                <?php if (isset($product_details[0]['id']) && !empty($product_details[0]['id']) && isset($product_details[0]['download_type']) && $product_details[0]['download_type'] == 'self_hosted') { ?>
                                                                                    <label class="text-danger mt-3">*Only Choose When
                                                                ...
                                                                <div class="form-group simple-product-save">
                                                                    <div class="col">
                                                                        <a href="javascript:void(0);"
                                                                            ...
                                                                            Settings</a>
                                                                        <a href="javascript:void(0);"
                                                                            class="btn btn-warning reset-settings <?= ($product_details[0]['type'] == "digital_product") ? 'disabled d-none' : ''; ?>"
                                                                            data-type="<?= $product_details[0]['type'] ?>">Reset
                                                                            Settings</a>
                                                                    </div>
                                                                </div>
                                                            <?php } else { ?>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <div class="col">
                                                                            <input type="checkbox"
                                                                                ...
                                                                                <?= (isset($product_details[0]['id']) && $product_details[0]['stock_type'] != NULL) ? 'checked' : '' ?>> <span class="align-middle">
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <select id="stock_level_type"
                                                                                ...
                                                                                <option value="product_level"
                                                                                    <?= (isset($product_details[0]['id']) && $product_details[0]['stock_type'] == '1') ? 'Selected' : '' ?>> Product Level ( Stock
                                                                                    Will Be Managed Generally )</option>
                                                                                <option value="variable_level"
                                                                                    <?= (isset($product_details[0]['id']) && $product_details[0]['stock_type'] == '2') ? 'Selected' : '' ?>>Variable Level ( Stock
                                                                                    Will Be Managed Variant Wise )</option>
                                                                            </select>
                                                                            <div
                                                                                class="form-group variant-product-level-stock-management <?= (intval($product_details[0]['stock_type']) == 1) ? '' : 'collapse' ?>">
                                                                                <div class="col col-xs-12">
                                                                                    <label class="control-label"
                                                                                        for="sku_variant_type">SKU <span
                                                                                            class='text-danger text-xs'>*</span>:</label>
                                                                                ...
                                                                                <div class="col col-xs-12">
                                                                                    <label class="control-label"
                                                                                        ...
                                                                                        Stock <span class='text-danger text-xs'>*</span>:</label>
                                                                                ...
                                                                                <div class="col col-xs-12">
                                                                                    ...
                                                                                    <select type="text"
                                                                                        ...
                                                                                        class="col form-control variant-stock-mustfill-field">
                                                                                        <option value="1"
                                                                                            <?= (intval($product_details[0]['stock_type']) == 1 && isset($product_variants[0]['id']) && $product_variants[0]['availability'] == '1') ? 'Selected' : '' ?>>In Stock
                                                                                        </option>
                                                                                        <option value="0"
                                                                                            <?= (intval($product_details[0]['stock_type']) == 1 && isset($product_variants[0]['id']) && $product_variants[0]['availability'] == '0') ? 'Selected' : '' ?>>Out Of Stock
                                                                                        </option>
                                                                                    </select>
                                                                                </div>
                                                                            </div>
                                                    ...
                                                    <div class="tab-pane fade" id="seo-section-settings" role="tabpanel"
                                                        aria-labelledby="seo-section-settings-tab">
                                                        <h4 class="bg-light m-0 px-2 py-3">SEO Configuration</h4>

                                                        <div class="d-flex bg-light">
                                                            <div class="form-group col-sm-6">
                                                                <label for="seo_page_title"
                                                                    class="form-label form-label-sm d-flex">
                                                                    SEO Page Title
                                                                </label>
                                                            ...
                                                            <div class="form-group col-sm-6">
                                                                ...
                                                                <input class='tags bg-white' id='seo_meta_keywords'
                                                                    placeholder="SEO Meta Keywords" name="seo_meta_keywords"
                                                        ...
                                                        <div class="d-flex bg-light">
                                                            ...
                                                            <div class="form-group col-sm-6">
                                                                ...
                                                                <textarea class="form-control" id="seo_meta_description"
                                                                    ...
                                                                    name="seo_meta_description"><?= isset($product_details[0]['seo_meta_description']) ? output_escaping($product_details[0]['seo_meta_description']) : "" ?></textarea>
                                                            </div>

                                                            <div class="col-sm-12 col-md-6">
                                                                <div class="form-group">
                                                                    <label for="image">SEO Open Graph Image
                                                                        <small>(Recommended Size : 131 x 131
                                                                            pixels)</small></label>
                                                                    <div class="col-sm-10">
                                                                        <div class='col-md-12'>
                                                                            <a class="uploadFile img btn btn-primary text-white btn-sm"
                                                                                data-input='seo_og_image'
                                                                                data-isremovable='1'
                                                                                data-is-multiple-uploads-allowed='0'
                                                                                data-toggle="modal"
                                                                                data-target="#media-upload-modal"
                                                                                value="Upload"><i class='fa fa-upload'></i>
                                                                                Upload</a>
                                                                        </div>
                                                                        <?php
                                                                        ...
                                                                        ?>
                                                                            ...
                                                                            <div
                                                                                class="container-fluid row image-upload-section">
                                                                                <div
                                                                                    class="col-md-12 col-sm-12 shadow p-3 bg-white rounded text-center grow image">
                                                                                    <div class='image-upload-div'><img
                                                                                            class="img-fluid mb-2"
                                                    ...
                                                    <div class="tab-pane fade" id="product-variants" role="tabpanel"
                                                        ...
                                                        <div>
                                                            <a class="btn btn-outline-primary btn-sm mb-3"
                                                                href="javascript:void(0)" id="expand_all">Expand All</a>
                                                            <a class="btn btn-outline-primary btn-sm mb-3 ml-4"
                                                                href="javascript:void(0)" id="collapse_all">Collapse All</a>
                                                        </div>
                                                        <div class="clearfix"></div>
                                                        <div
                                                    ...
                                                    <div class="col-12 row additional-info existing-additional-settings">
                                                        <div class="row mt-4 col-md-12 ">
                                                            <nav class="w-100">
                                                                <div class="nav nav-tabs" id="product-tab" role="tablist">
                                                                    ...
                                                                    <a class="nav-item nav-link"
                                                                        id="tab-for-general-seo-section" data-toggle="tab"
                                                                        href="#seo-section-settings" role="tab"
                                                                        aria-controls="general-seo-section"
                                                                        aria-selected="true">SEO Configuration</a>
                                                            ...
                                                            <div class="tab-content p-3 col-md-12" id="nav-tabContent">
                                                                <div class="tab-pane fade active show" id="general-settings"
                                                                    ...
                                                                    <div id="product-general-settings">
                                                                        <div id="general_price_section" class="collapse">
                                                                            <div class="d-flex">
                                                                                ...
                                                                                <div class="form-group col-md-6">
                                                                                    <label for="simple_special_price"
                                                                                        class="col-md-2">Special
                                                                                        Price<span
                                                                                            class='text-danger text-xs'>*</span></label>
                                                                                    <div class="">
                                                                                        <input type="number"
                                                                            ...
                                                                            <div
                                                                                class="form-group  simple_stock_management mx-2">
                                                                                <div class="d-flex">
                                                                                    <input type="checkbox"
                                                                                        name="simple_stock_management_status"
                                                                                        id="simple_stock_management_status"
                                                                                        class="align-middle simple_stock_management_status">
                                                                                    <label class="align-middle m-0 mx-2"
                                                                                        for="simple_stock_management_status">Enable
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div class="d-flex">
                                                                                ...
                                                                                <div class="col col-xs-12">
                                                                                    <label for="product_total_stock"
                                                                                        class="control-label">Total Stock <span
                                                                                            class='text-danger text-xs'>*</span>:</label>
                                                                                    <input type="number" min="1"
                                                                                ...
                                                                                <div class="col col-xs-12">
                                                                                    <label class="control-label">Stock
                                                                                        Status <span class='text-danger text-xs'>*</span></label>
                                                                                    <select type="text"
                                                                                        class="col form-control stock-simple-mustfill-field"
                                                                                        id="simple_product_stock_status">
                                                                    ...
                                                                    <div id="digital_product_setting" class="collapse">
                                                                        <div class="row form-group">
                                                                            ...
                                                                            <div class="col-md-3 col-xs-6 collapse"
                                                                                id='download_type'>
                                                                                <label for="download_allowed"
                                                                                    class="col-form-label">Download Link
                                                                                    Type <span
                                                                                        class='text-danger text-sm'>*</span></label>
                                                                                <select class='form-control'
                                                                                    name="download_link_type"
                                                                                    ...
                                                                                    <option value='add_link'>Add Link
                                                                                    </option>
                                                                                </select>
                                                                            </div>
                                                                            <div class="col-md-6 d-none"
                                                                                id="digital_link_container">
                                                                                <label for="video"
                                                                                    class="col-form-label ml-1">Digital
                                                                                    Product Link <span
                                                                                        class='text-danger text-sm'>*</span></label>
                                                                                <input type="url" class='form-control'
                                                                                    name='download_link' id='download_link'
                                                                ...
                                                                <div class="tab-pane fade" id="seo-section-settings"
                                                                    role="tabpanel"
                                                                    aria-labelledby="seo-section-settings-tab">
                                                                    <h4 class="bg-light m-0 px-2 py-3">SEO Configuration
                                                                    </h4>
                                                                        ...
                                                                        <div class="col-sm-12 col-md-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-sm-10">
                                                                                    ...
                                                                                    if (!empty(@$product_details[0]['seo_og_image'])) {
                                                                                    ?>
                                                                                        <label class="text-danger mt-3">*Only
                                    ...
                                    <div class="card-body pad">
                                        <div class="form-group col-md-12">
                                            ...
                                            <div class="mb-3">
                                                <textarea name="extra_input_description" id="extra_input_description"
                                                    class="textarea addr_editor"
                                                    placeholder="Place some text here"><?= (isset($product_details[0]['extra_description']) && !empty($product_details[0]['extra_description'])) ? output_escaping(str_replace('\r\n', '&#13;&#10;', $product_details[0]['extra_description'])) : ''; ?></textarea>
                                            </div>
