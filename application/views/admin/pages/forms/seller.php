                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body p-0">
                                <form class="form-horizontal" id="add-seller-commission-form"
                                    action="<?= base_url('admin/sellers/add-seller-commission'); ?>" method="POST"
                                    ...
                                    <div class="card-body row">
                                        ...
                                        <div class="form-group col-md-12  text-center">
                                            <button type="button" id="add_category" class="btn btn-primary"> <i
                                                    class="far fa-plus"></i> Add More Category </button>
                                        </div>
                                        <br>
                ...
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal form-submit-event"
                            action="<?= base_url('admin/sellers/add_seller'); ?>" method="POST" id="add_product_form">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="email" class="form-control" id="email" placeholder="Enter Email"
                                            name="email" value="<?= @$fetched_data[0]['email'] ?>">
                                    </div>
                                </div>
                                <?php
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea type="text" class="form-control" id="address"
                                            ...
                                            name="address"><?= isset($fetched_data[0]['address']) ? @$fetched_data[0]['address'] : ""; ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <?php } ?>
                                        <input type="file" class="form-control file_upload_height" name="authorized_signature"
                                ...
                                <?php if (isset($fetched_data[0]['authorized_signature']) && !empty($fetched_data[0]['authorized_signature'])) { ?>
                                    <div class="form-group row">
                                        <div class="mx-auto product-image"><a
                                                href="<?= base_url($fetched_data[0]['authorized_signature']); ?>"
                                ...
                                <div class="form-group row">
                                    <label for="commission" class="col-sm-2 col-form-label">Commission(%)
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" max="100" min="0" class="form-control"
                                            ...
                                            name="global_commission" value="<?= @$fetched_data[0]['commission'] ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <?php
                                    ...
                                    ?>
                                    <label for="commission" class="col-sm-8 col-form-label">Choose Categories &
                                        Commission(%) <small>(Commission(%) to be given to the Super Admin on order item
                                            by Category you select.If you do not set the commission beside category then
                                            it will get global commission other wise perticuler category commission will
                                            be consider.)</small> </label>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-3 offset-2">
                                        <a href="javascript:void(0)" id="seller_model"
                                            ...
                                            title="Manage Categories & Commission" data-target="#set_commission_model"
                                            data-toggle="modal">Manage</a>
                                    </div>
                                </div>
                                <?php
                                ...
                                <div class="form-group row deliverable_type">
                                    <?php if ((isset($shipping_method['pincode_wise_deliverability']) && $shipping_method['pincode_wise_deliverability'] == 1) || (isset($shipping_method['local_shipping_method']) && isset($shipping_method['shiprocket_shipping_method']) && $shipping_method['local_shipping_method'] == 1 && $shipping_method['shiprocket_shipping_method'] == 1)) { ?>
                                        ...
                                        <label for="deliverable_type" class="col-form-label col-sm-2">Deliverable Zipcode
                                            Type</label>
                                        <div class="form-group col-sm-10">
                                            <select class="form-control" name="deliverable_zipcode_type"
                                                ...
                                                <option value="<?= EXCLUDED ?>"
                                                    <?= (isset($fetched_data[0]['deliverable_zipcode_type']) && $fetched_data[0]['deliverable_zipcode_type'] == 2) ? 'selected' : ''; ?>>
                                                    Excluded</option>
                                            </select>
                                        </div>
                                    ...
                                    if (isset($shipping_method['city_wise_deliverability']) && $shipping_method['city_wise_deliverability'] == 1 && $shipping_method['shiprocket_shipping_method'] != 1) { ?>
                                        ...
                                        <div class="form-group col-sm-10">
                                            <select class="form-control" name="deliverable_city_type"
                                                ...
                                                <option value="<?= ALL ?>"
                                                    <?= (isset($fetched_data[0]['deliverable_city_type']) && $fetched_data[0]['deliverable_city_type'] == 1) ? 'selected' : ''; ?>>All
                                                </option>
                                                <option value="<?= EXCLUDED ?>"
                                ...
                                <div class="form-group row">
                                    <?php if ((isset($shipping_method['pincode_wise_deliverability']) && $shipping_method['pincode_wise_deliverability'] == 1) || (isset($shipping_method['local_shipping_method']) && isset($shipping_method['shiprocket_shipping_method']) && $shipping_method['local_shipping_method'] == 1 && $shipping_method['shiprocket_shipping_method'] == 1)) { ?>
                                        ...
                                        <label for="serviceable_zipcodes" class="col-form-label col-sm-2">Serviceable
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <select name="serviceable_zipcodes[]" class="search_zipcode form-control w-100"
                                                ...
                                                <?= (isset($fetched_data[0]['deliverable_zipcode_type']) && ($fetched_data[0]['deliverable_zipcode_type'] == INCLUDED || $fetched_data[0]['deliverable_zipcode_type'] == EXCLUDED)) ? "" : "disabled" ?>>
                                                <?php if (isset($zipcodes) && !empty($zipcodes)) {
                                                    foreach ($zipcodes_name as $row) {
                                                        ?>
                                                        <option value="<?= $row['id'] ?>" <?= (!empty($zipcodes) && in_array($row['id'], $zipcodes)) ? 'selected' : ''; ?>>
                                                            <?= $row['zipcode'] ?></option>
                                                    <?php }
                                                } ?>
                                            </select>
                                    ...
                                    if (isset($shipping_method['city_wise_deliverability']) && $shipping_method['city_wise_deliverability'] == 1 && $shipping_method['shiprocket_shipping_method'] != 1) { ?>
                                        ...
                                        <label for="cities" class="col-form-label col-sm-2">Serviceable Cities <span
                                                class='text-danger text-sm'>*</span></label>
                                        <?php
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <select class="form-control city_list" name="serviceable_cities[]"
                                                id="deliverable_cities" multiple
                                                <?= (isset($fetched_data[0]['deliverable_city_type']) && ($fetched_data[0]['deliverable_city_type'] == INCLUDED || $fetched_data[0]['delideliverable_city_typeverable_zipcode_type'] == EXCLUDED)) ? "" : "disabled" ?>>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="store_name" placeholder="Store Name"
                                            name="store_name" value="<?= @$fetched_data[0]['store_name'] ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <?php if (isset($fetched_data[0]['logo']) && !empty($fetched_data[0]['logo'])) { ?>
                                    <div class="form-group row">
                                        <div class="mx-auto product-image"><a
                                                href="<?= base_url($fetched_data[0]['logo']); ?>" data-toggle="lightbox"
                                                data-gallery="gallery_seller"><img
                                ...
                                <div class="form-group row">
                                    <label for="tax_name" class="col-sm-2 col-form-label">Tax Name <span
                                            class='text-danger text-sm'>*</span></label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="tax_name" placeholder="Tax Name"
                                            name="tax_name" value="<?= @$fetched_data[0]['tax_name'] ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="tax_number" class="col-sm-2 col-form-label">Tax Number <span
                                            class='text-danger text-sm'>*</span></label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="tax_number" placeholder="Tax Number"
                                            name="tax_number" value="<?= @$fetched_data[0]['tax_number'] ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="latitude" placeholder="Latitude"
                                            name="latitude" value="<?= @$fetched_data[0]['latitude'] ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="longitude" placeholder="Longitude"
                                            name="longitude" value="<?= @$fetched_data[0]['longitude'] ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label for="require_products_approval" class="col-sm-2 form-label">Require Product's
                                        Approval?</label>
                                    <div class="col-sm-1">
                                        <input type="checkbox" name="require_products_approval"
                                    ...
                                    <div class="col-sm-1">
                                        <input type="checkbox" name="customer_privacy"
                                            <?= (isset($permit['customer_privacy']) && $permit['customer_privacy'] == '1') ? 'Checked' : '' ?> data-bootstrap-switch data-off-color="danger"
                                ...
                                <div class="d-flex bg-light">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-group">
                                            <label for="image">SEO Open Graph Image <small>(Recommended Size : 131 x 131
                                                    pixels)</small></label>
                                            <div class="col-sm-10">
                                                <div class='col-md-12'>
                                                    <a class="uploadFile img btn btn-primary text-white btn-sm"
                                                        ...
                                                        data-target="#media-upload-modal" value="Upload"><i
                                ...
                                <div class="form-group my-3">
                                    ...
                                    <button type="submit" class="btn btn-success"
                                        id="submit_btn"><?= (isset($fetched_data[0]['id'])) ? 'Update Seller' : 'Add Seller' ?></button>
                                </div>
                            </div>
