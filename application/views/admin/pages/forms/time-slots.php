                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-1">
                                            <input type="checkbox" id="is_time_slots_enabled" name="is_time_slots_enabled" <?= (@$time_slot_config['is_time_slots_enabled']) == '1' ? 'Checked' : '' ?> data-bootstrap-switch data-off-color="danger" data-on-color="success">
                                        </div>
                                        <div class="form-group col-md-7" id="timeslot_note">
                                            <p class="text-blue font-weight-bold">Please add time slots below for use time slots </p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            <label for="">Delivery Starts From ?<span class='text-danger text-sm'>*</span></label>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            <label for="">How many days you want to allow ?<span class='text-danger text-sm'>*</span></label>
                                        </div>
                                        <div class="form-group col-md-8">
                    ...
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal form-submit-event" action="<?= base_url('admin/Time_slots/update_time_slots'); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label for="">From Time <span class='text-danger text-sm'>*</span></label>
                                    </div>
                                    <div class="form-group col-md-8">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label for="">To Time <span class='text-danger text-sm'>*</span></label>
                                    </div>
                                    <div class="form-group col-md-8">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label for="">Last Order Time <span class='text-danger text-sm'>*</span></label>
                                    </div>
                                    <div class="form-group col-md-8">
