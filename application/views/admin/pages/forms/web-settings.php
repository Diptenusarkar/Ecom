                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea name="meta_keywords" id="meta_keywords" class="form-control" cols="30" rows="5"><?= (isset($web_settings['meta_keywords'])) ? str_replace(array("\n\r", "\n", "\r", "\\"), "", $web_settings['meta_keywords']) : '' ?></textarea>
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="support_email">Meta Description <span class='text-danger text-xs'>*</span></label>
                                        <textarea name="meta_description" id="meta_description" class="form-control" cols="30" rows="5"><?= (isset($web_settings['meta_description'])) ? str_replace(array("\n\r", "\n", "\r", "\\"), "", $web_settings['meta_description']) : '' ?></textarea>
                                    </div>
                                </div>
                                <hr>
                                    ...
                                    <div class="form-group col-md-7 pl-0">
                                        ...
                                        <select id="modern_theme_color" name="modern_theme_color" class="form-control col-md-5">
                                            ...
                                            <?php foreach ($colors as $color_value => $color_name) : ?>
                                                <option value="<?= $color_value ?>" <?= (isset($web_settings['modern_theme_color']) && $web_settings['modern_theme_color'] == $color_value) ? 'selected' : '' ?>><?= $color_name ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
