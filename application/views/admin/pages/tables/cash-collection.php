                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <input type="text" name="order_amount" id="amount" class="form-control" disabled>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                        ...
                        <div class="col-md-6 ">
                            <div class="card content-area p-4">
                                ...
                                <div class="card-innr">
                                    ...
                                    <table class='table table-striped' data-toggle="table" data-show-footer="false" data-url="<?= base_url('admin/delivery_boys/get_cash_collection') ?>" data-click-to-select="true" data-side-pagination="server" data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200]" data-search="true" data-show-columns="true" data-show-refresh="true" data-trim-on-search="false" data-sort-name="id" data-sort-order="desc" data-mobile-responsive="true" data-toolbar="" data-show-export="true" data-maintain-selected="true" data-export-types='["txt","excel"]' data-export-options='{
