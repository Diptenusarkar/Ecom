                    ...
                    <div class="card content-area p-4">
                        ...
                        <div class="card-header border-0">
                            <div class="card-tools">
                                <a href="<?= base_url() . 'admin/blogs/create-category' ?>" class="btn btn-block  btn-outline-primary btn-sm">Add Category</a>
                            </div>
                        </div>
