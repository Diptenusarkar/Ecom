                ...
                <div class="col-md-12 ">
                    <div class="card content-area p-4">
                        <div class="card-innr">
                            ...
                            ?>
                            <div class="align-items-center card-head d-flex justify-content-between">
                                <h4 class="card-title">Countries </h4>
                                <a href="<?= base_url('admin/area/countries_bulk_dowload') ?>" class="btn btn-info mt-1 mb-1" download="<?= $filename_countries ?>">Country Download file <i class="fas fa-download"></i></a>
