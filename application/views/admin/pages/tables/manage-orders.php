                    ...
                    <div class="card content-area p-4">
                        <div class="card-innr">
                            ...
                            <div class="row col-md-12">
                                ...
                                <div class="row mx-2 pull-right">
                                    <a href="#" class="btn btn-info btn-sm settle_referal_cashback_discount" title="If you found Settle referral Cashback Discount not crediting using cron job you can update Settle user's Reffral Cashback Discount from here!">Settle User Cashback Discount</a>
                                </div>
                                <div class="row mx-2 pull-right">
                                    <a href="#" class="btn btn-secondary btn-sm settle_referal_cashback_discount_for_referal" title="If you found Settle referral Cashback Discount not crediting using cron job you can update Settle referral Cashback Discount from here!">Settle referral Cashback Discount</a>
                                </div>
                            </div>
                            <hr>
