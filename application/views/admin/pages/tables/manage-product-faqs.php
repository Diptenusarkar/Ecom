                                ...
                                <form class="form-horizontal form-submit-event" id="product_edit_faq_form" action="<?= base_url('admin/product/edit_product_faqs'); ?>" method="POST" enctype="multipart/form-data">
                                    <div class="card-body">
                                        ...
                                        if (isset($fetched_data[0]['id'])) { ?>
                                            ...
                                            <input type="hidden" name="question" value="<?= @$fetched_data[0]['question'] ?>">
                                            <input type="hidden" name="seller_id" value="<?= @$fetched_data[0]['seller_id'] ?>">
                                            <input type="hidden" name="product_id" value="<?= @$fetched_data[0]['product_id'] ?>">
                                        <?php  } ?>
                                        <div class="form-group row">
                                            <label for="question" class="col-sm-2 col-form-label">Question </label>
                                            <div class="col-sm-10">
                                                <textarea class="form-control" id="question" placeholder="question" name="question" cols="30" rows="10" disabled><?= @$fetched_data[0]['question'] ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="answer" class="col-sm-2 col-form-label">Answer <span class='text-danger text-sm'>*</span></label>
                                            <div class="col-sm-10">
                                                <textarea class="form-control" id="answer" placeholder="Answer" name="answer" id="answer" cols="30" rows="10"><?= @$fetched_data[0]['answer'] ?></textarea>
                                            </div>
                                        </div>
                            ...
                            "ignoreColumn": ["state"] 
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="question" data-sortable="false" data-align='center' data-formatter="itemsReadMoreFormatter">Question</th>
                                        <th data-field="answer" data-sortable="false" data-align='center' data-formatter="itemsReadMoreFormatter">Answer</th>
