                                ...
                                <div class="modal-body p-0">
                                    <form class="form-horizontal form-submit-event add_slider_form" method="POST" id="add_slider_form" enctype="multipart/form-data">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <div>
                                                    <label for="image" class="form-label form-label-sm">
                                                        Slider Image<span class='text-danger text-sm'>*</span>
                                                        <small>(Recommended Size : 1648 x 610 pixels)</small></label>
                                                </div>
                                                <div class="col-sm-10">
                                                    ...
                                                    <label class="text-danger mt-1 edit_slider_upload_image_note">*Only Choose When
                                            ...
                                            <div class="form-group">
                                                ...
                                                <button type="submit" class="btn btn-success save_slider" id="submit_btn"><?= (isset($fetched_data[0]['id'])) ? 'Update Slider' : 'Add Slider' ?></button>
                                            </div>
                    ...
                    <div class="card content-area p-4">
                        <div class="card-header border-0">
                            <div class="card-tools">
                                <button type="button" class="btn btn-block  btn-outline-primary btn-sm add_slider_btn" data-toggle="modal" data-target="#add_slider">
                                    Add Slider
                                </button>
                            </div>
                        </div>
