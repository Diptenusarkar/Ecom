                        ...
                        <div class="card-innr">
                            <div class="gaps-1-5x">
                                <div class="row d-flex align-items-end flex-wrap">
                                    ...
                                    <div class="form-group col-12 col-md-12 mb-3 d-flex justify-content-end gap-2">
                                        <button type="button" class="btn btn-outline-danger btn-sm mr-2" onclick="resetfilters()" aria-label="Clear Filters">Clear</button>
                                        <button type="button" class="btn btn-outline-primary btn-sm" onclick="status_date_wise_search()" aria-label="Apply Filters">Filter</button>
                                    </div>
                                </div>
                            </div>
                            <div class="card shadow-sm p-4 mb-4 bg-light border-left-primary">
                                <h6 class="font-weight-bold text-primary">
                                    ...
                                    <span id="total-order-sum" class="text-dark"><?= isset($curreny) ? $curreny : '$' ?> 0.00</span>
                                </h6>
                            </div>
