<section class="deeplink_wrapper"></section>
<section class="mt-2">
                    ...
                    <?php if (isset($sliders) && !empty($sliders)) { ?>
                        <?php foreach ($sliders as $row) { ?>
                            <div class="swiper-slide center-swiper-slide">
                                <a href="<?= $row['link'] ?>">
                                    <img src="<?= base_url('media/image?path=' . rawurlencode($row['image']) . '&width=1518&quality=80') ?>">
                                </a>
                            </div>
                        <?php } ?>
                    <?php } ?>
...
<section class="main-content mt-md-2 mt-sm-0">
    <div class="category-section container-fluid text-center dark-category-section icon-dark-sec">
        <div class="text-center text-black category-section-title">
            <h3 class="h2"><?= !empty($this->lang->line('category')) ? str_replace('\\', '', $this->lang->line('category')) : 'Popular Categories' ?></h3>
        </div>
        <!-- Swiper -->
                            ...
                            <div class="category-image">
                                <div class="category-image-container brand_image">
                                    <a href="<?= base_url('products/category/' . html_escape($row['slug'])) ?>">
                                        <img src="<?= base_url('media/image?path=' . rawurlencode($row['relative_path']) . '&width=130&quality=80') ?>" class="brand_img">
                                    </a>
                                </div>
                            </div>
    ...
    <!-- <section class="mt-3"> -->
    <div class="container-fluid my-4 overflow-hidden product-section">
        <div class="my-3">
            <div class="align-items-center d-flex justify-content-between">
                <div class="">
                    <h3 class="text-dark mb-0 h3"><?= !empty($this->lang->line('brands')) ? str_replace('\\', '', $this->lang->line('brands')) : 'Brands'; ?></h3>
                </div>
                <div class="col-md-2">
        ...
        <div class="my-4">
            <div class="swiper-container brand-swiper text-center" data-dots="true">
                        ...
                        <div class="swiper-slide swiper-slide-brand">
                            <a href="<?= base_url('products?brand=' . html_escape($row['brand_slug'])) ?>" class="text-decoration-none">
                                <div class="brand_image">
                                    <img class="lazy brand_img" src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>" data-src="<?= base_url('media/image?path=' . rawurlencode($row['brand_img']) . '&width=100&quality=80') ?>" alt="<?= html_escape($row['brand_name']) ?>" />
                                </div>
                ...
                <div class="swiper-controls">
                    <div class="swiper-pagination brand-swiper-pagination swiper-pagination-clickable swiper-pagination-bullets swiper-pagination-horizontal">
            ...
            if ($row['style'] == 'default') {
                if ($count_key != 0) {
                    ...
                    if (!empty($offers) && !empty($offers[$count_key - 1])) { ?>
                        <a href="<?= $offers[$count_key - 1]['link'] ?>" class="offer_image">
                            <img class="img-fluid lazy" data-src="<?= base_url('media/image?path=' . rawurlencode($offers[$count_key - 1]['image']) . '&width=1518&quality=80') ?>">
                        </a>
                <?php }
                } ?>
                <!-- Default Style Design-->
                <div class="product-style-default product-section py-2 bg-white mt-2 mb-2 container-fluid">
                    <div class="my-4 featured-section-title ml-2">
                        <div class="row">
                            <div class="align-items-center col-md-12 d-flex justify-content-between">
                                ...
                                <div class="col-md-2 mt-5">
                                    <a href="<?= base_url('products/section/' . $row['id'] . '/' . $row['slug']) ?>" class="featured-section-view-more"><?= !empty($this->lang->line('view_more')) ? str_replace('\\', '', $this->lang->line('view_more')) : 'View More' ?></a>
                                </div>
                            </div>
                        </div>
                        <hr>
                                                ...
                                                <div class="product-image">
                                                    <div class="product-image-container">
                                                        <a href="<?= base_url('products/details/' . $product_row['slug']) ?>">
                                                            <img class="pic-1 lazy" data-src="<?= base_url('media/image?path=' . rawurlencode($product_row['relative_path']) . '&width=230&quality=80') ?>">
                                                        </a>
                                                    </div>
                                                    <ul class="social">
                                                        <li>
                                                            <a href="#" class="quick-view-btn" data-tip="<?= !empty($this->lang->line('quick_view')) ? str_replace('\\', '', $this->lang->line('quick_view')) : 'Quick View' ?>" data-product-id="<?= $product_row['id'] ?>" data-product-variant-id="<?= $product_row['variants'][0]['id'] ?>" data-izimodal-open="#quick-view">
                                                        ...
                                                        <li>
                                                            ...
                                                            ?>
                                                            <a href="#" class="compare" data-tip="<?= !empty($this->lang->line('compare')) ? str_replace('\\', '', $this->lang->line('compare')) : 'Compare' ?>" data-product-id="<?= $product_row['id'] ?>" data-product-variant-id="<?= $variant_id ?>">
                                                    ...
                                                    <?php if (isset($product_row['min_max_price']['special_price']) && $product_row['min_max_price']['special_price'] != '' && $product_row['min_max_price']['special_price'] != 0 && $product_row['min_max_price']['special_price'] < $product_row['min_max_price']['min_price']) { ?>
                                                        <span class="product-new-label"><?= !empty($this->lang->line('sale')) ? str_replace('\\', '', $this->lang->line('sale')) : 'Sale' ?><?= $product_row['min_max_price']['discount_in_percentage'] ?>%</span>
                                    ...
                                    <div class="col-md-4">
                                        <div class="product-grid">
                                            ...
                                            <div class="product-image">
                                                <div class="product-image-container">
                                                    <a href="<?= base_url('products/details/' . $product_row['slug']) ?>">
                                                        <img class="pic-1 lazy" data-src="<?= base_url('media/image?path=' . rawurlencode($product_row['relative_path']) . '&width=270&quality=80') ?>">
                                                    </a>
                                                </div>
                                                <ul class="social">
                                                    <li>
                                ...
                                <div class="product-image-container d-flex align-items-center justify-content-center">
                                    <div>
                                        <a href="<?= base_url('products/details/' . $last_product['slug']) ?>">
                                            <img class="pic-1 lazy" data-src="<?= base_url('media/image?path=' . rawurlencode($last_product['relative_path']) . '&width=450&quality=80') ?>">
                                        </a>
                                    </div>
                                </div>
                                <ul class="social">
                                    <li>
                                        <a href="#" class="quick-view-btn" data-tip="<?= !empty($this->lang->line('quick_view')) ? str_replace('\\', '', $this->lang->line('quick_view')) : 'Quick View' ?>" data-product-id="<?= $last_product['id'] ?>" data-product-variant-id="<?= $last_product['variants'][0]['id'] ?>" data-izimodal-open="#quick-view">
                                            <i class="fa fa-search"></i>
                                        </a>
                                    </li>
                                    <li>
                        ...
                        <div class="product-grid">
                                ...
                                <div class="product-image-container d-flex align-items-center justify-content-center">
                                    <div>
                                        <a href="<?= base_url('products/details/' . $first_product['slug']) ?>">
                                            <img class="pic-1 lazy" data-src="<?= base_url('media/image?path=' . rawurlencode($first_product['relative_path']) . '&width=450&quality=80') ?>">
                                        </a>
                                    </div>
                                </div>
                                <ul class="social">
                                    <li>
                                        <a href="#" class="quick-view-btn" data-tip="<?= !empty($this->lang->line('quick_view')) ? str_replace('\\', '', $this->lang->line('quick_view')) : 'Quick View' ?>" data-product-id="<?= $first_product['id'] ?>" data-product-variant-id="<?= $first_product['variants'][0]['id'] ?>" data-izimodal-open="#quick-view">
                                            <i class="fa fa-search"></i>
                                        </a>
                                    </li>
                                    <li>
                            ...
                            <div itemscope itemtype="https://schema.org/Product">
                                <div class="product-content">
                                    ...
                                    <?php if ($first_product['variants'][0]['special_price'] < $first_product['variants'][0]['price']) { ?>
                                        <p class="mb-2 mt-2">
                                            <span id="" style='font-size: 20px;'>
                                                <?php echo $settings['currency'] ?>
                                                <?php
                            ...
                            <div class="col-md-2">
                                <div class="product-grid">
                                    ...
                                    <div class="product-image">
                                        <div class="product-image-container">
                                            <a href="<?= base_url('products/details/' . $product_row['slug']) ?>">
                                                <img class="pic-1 lazy" data-src="<?= base_url('media/image?path=' . rawurlencode($product_row['relative_path']) . '&width=215&quality=80') ?>">
                                            </a>
                                        </div>
                                        <ul class="social">
                                            <li>
                                    ...
                                    <div class="product-image-container">
                                        <div class="featured-section-title">
                                            <div class="col-md-12">
                                                <h3 class="section-title "><?= ucfirst($row['title']) ?></h3>
                                                <div class="title-sm"><?= $row['short_description']; ?></div>
                                                <div class="col-12"><a href="<?= base_url('products/section/' . $row['id'] . '/' . $row['slug']) ?>" class="featured-section-view-more"><?= !empty($this->lang->line('view_more')) ? str_replace('\\', '', $this->lang->line('view_more')) : 'View More' ?></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
