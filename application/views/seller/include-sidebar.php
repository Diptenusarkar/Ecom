        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent nav-flat" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item">
                    <a href="<?= base_url('seller/brands') ?>" class="nav-link">
                        <i class="fab fa-adversal nav-icon text-primary"></i>
                        <p>Brands</p>
                    </a>
                </li>
                ...
                <li class="nav-item has-treeview ">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('seller/products') ?>" class="nav-link">
                                <i class="fas fa-boxes nav-icon"></i>
                                <p>Manage Products</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= base_url('seller/product/product_bulk_edit') ?>" class="nav-link">
                                <i class="fas fa-boxes nav-icon"></i>
                ...
                <?php if (isset($shipping_settings['shiprocket_shipping_method']) && $shipping_settings['shiprocket_shipping_method'] == 1) { ?>
                ...
                <li class="nav-item has-treeview">
                    <a href="<?= base_url('seller/policy') ?>" class="nav-link">
                        <i class="fa fa-lock nav-icon text-success"></i>
                        <p>Privacy Policy</p>
                    </a>
                </li>
                <li class="nav-item has-treeview">
                    <a href="<?= base_url('seller/policy/terms_conditions') ?>" class="nav-link">
