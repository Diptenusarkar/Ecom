            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        <!-- form start -->
                        <form class="form-horizontal" action="<?= base_url('seller/product/add_product'); ?>"
                            method="POST" enctype="multipart/form-data" id="save-product">
                            <input type="hidden" name="seller_id"
                                value="<?= (isset($seller_id) && !empty($seller_id)) ? $seller_id : $_SESSION['user_id']; ?>">
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="pro_input_text"
                                        ...
                                        value="<?= (isset($product_details[0]['name'])) ? $product_details[0]['name'] : "" ?>">
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 mt-1">
                                        ...
                                        <input name='tags' class='col-md-12' id='tags'
                                ...
                                <div class="form-group row">
                                    <div class="col-md-8">
                                        <div class="row col mt-3">
                                                ...
                                                <select class=" col-md-12  form-control admin_brand_list"
                                                    ...
                                                    ?>
                                                        <option value="<?= $product_details[0]['brand'] ?>"
                                                            <?= (isset($product_details[0]['brand']) && (count($brands) > 0) && ($product_details[0]['brand'] == $brands[0]['id'])) ? 'selected' : ''; ?>><?= $product_details[0]['brand'] ?></option>
                                                    <?php } ?>
                                                    <!-- brands display here  -->
                                                </select>
                                            </div>
                                            <div
                                                ...
                                                <input type="number" class="col-md-12 form-control"
                                                    id="total_allowed_quantity" name="total_allowed_quantity"
                                                    value="<?= (isset($product_details[0]['total_allowed_quantity'])) ? $product_details[0]['total_allowed_quantity'] : ''; ?>"
                                                    placeholder='Total Allowed Quantity' min="1">
                                            </div>
                                            <div
                                            ...
                                            <!-- HSN Code -->
                                            <div
                                                class="col-md-4 mt-3 hsn_code <?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md-6">
                                                <label for="low_stock_limit" class="col-form-label">Low Stock
                                                    Limit<small>(Seller’s default low stock limit will apply if this is
                                                        not specified)</small></label>
                                            ...
                                            <div class="col-md-6 pickup_locations <?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                                <div class="standdard_shipping">
                                                    <label for="shipping_type" class="col-form-label">For standdard shipping
                                                        <?php
                                        ...
                                        <div class="col pt-4 pb-4">
                                            ...
                                            <div class="form-group">
                                                <label for="other_images">Other Images <small>(Recommended Size : 180 x
                                                        180 pixels)</small></label>
                                                <div class="col-sm-12">
                                                    <div class='col-md-3'><a
                                                            class="uploadFile img btn btn-primary text-white btn-sm"
                                    ...
                                    <div class="col-md-4">
                                        <label for="pro_input_tax"
                                            class="col-form-label"><?= !empty($this->lang->line('select_category')) ? $this->lang->line('select_category') : 'Select Category' ?>
                                            <span class='text-danger text-sm'>*</span></label>
                                                        ...
                                                        <div id='product-general-settings'>
                                                            ...
                                                            ?>
                                                                <div id="general_price_section">
                                                                    <div class="form-group">
                                                                        <label for="type" class="col-md-2">Price<span class='text-danger text-xs'>*</span></label>
                                                                        <div class="col-md-12">
                                                                    ...
                                                                    <div
                                                                        class="form-group row mt-4 dimensions  <?= $product_details[0]['type'] == "digital_product" ? 'd-none' : '' ?>">
                                                                        <div class="col-3">
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div class="col col-xs-12">
                                                                                    <label class="control-label"
                                                                                        for="sku_variant_type">SKU <span class='text-danger text-xs'>*</span>:</label>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <div class="col">
                                                                            <a href="javascript:void(0);"
                                                                                ...
                                                                                Settings</a>
                                                                            <a href="javascript:void(0);"
                                                                                class="btn btn-warning reset-settings <?= ($product_details[0]['type'] == "digital_product") ? 'disabled d-none' : ''; ?>">Reset
                                                                                Settings</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                            ...
                                                                            <div class="flex">
                                                                                ...
                                                                                <div class="col col-xs-12">
                                                                                    <label for="product_total_stock"
                                                                                        class="control-label">Total Stock
                                                                                        <span class='text-danger text-xs'>*</span>:</label>
                                                                                    <input type="text"
                                    ...
                                    <div class="card-body pad">
                                        ...
                                        <div class="mb-3">
                                            <textarea name="extra_input_description" class="textarea addr_editor"
